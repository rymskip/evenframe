...
export class Purchased extends Schema.Class<Purchased>("Purchased")( { 
  id: Schema.propertySignature(Schema.String.pipe(Schema.nonEmptyString({ message: () => `Please enter a value` }))).annotations({ missingMessage: () => `'Id' is required` }),
  in: Schema.propertySignature(Schema.Union(Schema.String.pipe(Schema.nonEmptyString()), Customer).annotations({ message: () => ({
                message: `Please enter a valid value`,
                override: true,
            }), })).annotations({ missingMessage: () => `'In' is required` }),
  out: Schema.propertySignature(Schema.Union(Schema.String.pipe(Schema.nonEmptyString()), Order).annotations({ message: () => ({
                message: `Please enter a valid value`,
                override: true,
            }), })).annotations({ missingMessage: () => `'Out' is required` }),
  purchasedAt: Schema.propertySignature(Schema.String.pipe(Schema.nonEmptyString({ message: () => `Please enter a value` }))).annotations({ missingMessage: () => `'Purchased At' is required` })
}) {[key: string]: unknown}
...
export interface PurchasedEncoded {
  readonly id: string;
  readonly in: string | CustomerEncoded;
  readonly out: string | OrderEncoded;
